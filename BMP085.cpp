...
int32_t BMP085::readPressure(bool use_mmhg) {
  ...
  Serial.print("p = "); Serial.println(p);
#endif
  return use_mmhg ? (p * 0.00750061683) : p;
}

int32_t BMP085::readSealevelPressure(float altitude_meters) {
  float pressure = readPressure(false);
  return (int32_t)(pressure / pow(1.0-altitude_meters/44330, 5.255));
}

float BMP085::readTemperature(bool use_fahrenheit) {
